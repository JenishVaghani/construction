          ...
          <div className="p-4 ">
            ...
            <div className="flex items-center space-x-3 mt-4 rounded-lg">
              <button
                ...
                className="sm:static fixed bottom-6 right-6 w-12 h-12 flex items-center justify-center cursor-pointer bg-[#15616D] text-white hover:bg-[#0E4A52] rounded-full text-2xl shadow-lg z-10 sm:z-auto"
              >
                +
              </button>
