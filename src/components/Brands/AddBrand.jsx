...
import { BRANDCATEGORYS, CEMENTSIZESNAME, STEALSIZESNAME } from '../../utils/constants';
            ...
            <div className="p-2">
                ...
                <div className="pl-16 pt-6">
                    <div className="flex items-center mb-4">
                        <InputField label="Name" type="text" onChange={(e) => setBrandName(e.target.value)} />
                    </div>
                    <div className="flex items-center mb-4">
                        <DropDownField items={brands} title="Category" onChange={setBrandCategory} />
                    </div>
                    <div className="flex items-center mb-4">
                        <MultiSelectDropDownField items={sizes} title="Size" onChange={setBrandSizes} />
                    </div>
                    <div className="flex items-center mb-4 pl-12">
                        <button onClick={hanleAddBrand} className="px-10 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 cursor-pointer">
                            Add
                        </button>
                    </div>
                </div>
