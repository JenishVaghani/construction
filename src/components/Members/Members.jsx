          ...
          <div className="flex flex-wrap items-center rounded-lg w-full gap-4 md:gap-6">
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className="sm:static fixed bottom-6 right-6 w-12 h-12 flex items-center justify-center cursor-pointer bg-[#15616D] text-white hover:bg-[#0E4A52] rounded-full text-2xl shadow-lg z-0 sm:10"
              >
                +
              </button>
